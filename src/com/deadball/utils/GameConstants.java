...
public interface GameConstants {
    ...
    String PHASE_AIM = "AIM";
    String PHASE_SHOOT = "SHOOT";
    String PHASE_RESULT = "RESULT";
    ...
    String HUD_SUCCESS = "#00C854";

    /** Goal mouth in sim space; shared by ball physics, keeper slice logic, and aim-inside checks. */
    static boolean isInsideGoalFrame(double x, double y) {
        return x >= GOAL_LEFT && x <= GOAL_RIGHT && y >= GOAL_TOP && y <= GOAL_BOTTOM;
    }
